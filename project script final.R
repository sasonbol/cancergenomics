...
studies1<- c("laml_tcga_pub", "laml_tcga", "blca_tcga_pub", "blca_tcga", 
             ...
             "luad_tcga")
#the first 34 genes are cancer-relaated genes according to different studies,
#while the next 16 genes are randomly chosen genes
genes<- c("FGFR3", "RB1", "HRAS", "TP53", "TSC1", "BRAF", "NRAS", "RRAS", "SMAD4",
          "PTEN", "TACC3", "TERT", "PIK3CA", "VHL", "WT1", "MET", "FLCN","TSC2", 
          "FH","SDHB","FLT3","IDH1","IDH2","RUNX1","CEBPA","KIT","PTPN11", "KRAS",
          "PTENP1","FAS","ALK","ERBB2","AKT1","MAP2K1","ARL1","ARL2", "AGTR1", 
          "PTAFR","GPR32","EDNRA","SSTR1","AVPR2","OXTR","LGR4","KCNA1","KCNQ1",
          "CHL1", "MERTK", "MRPS36", "MOB4")
...
combined[!is.na(combined[,1:50])]<- "1"
combined[is.na(combined[,1:50])]<- "0"
