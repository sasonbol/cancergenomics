...
studies1<- c("laml_tcga_pub", "laml_tcga", "blca_tcga_pub", "blca_tcga", 
             ...
             "luad_tcga")
#These are cancer specific genes (42 selected genes)
genes<- c("VHL", "MET", "FLCN", "FH" , "SDHB", "TACC3", "TERT", "PIK3CA", "PBRM1",
          "TSC2", "PIK3R1", "FGFR3", "ANXA10", "AHNAK2", "CTSE", 
          "CRH", "IGF2", "KLF9", "KRT20", "MAGEA3", "POSTN", "SLC1A6",
          "FLT3", "IDH1", "IDH2", "RUNX1", "CEBPA", "KIT",  "PTPN11", "NPM1", 
          "DNMT3A", "KRAS", "PTENP1", "FAS", "ALK", "ERBB2", "AKT1", "MAP2K1", 
           "RET", "ROS1", "EGFR", "DDR2")
...
combined[!is.na(combined[,1:42])]<- "1"
combined[is.na(combined[,1:42])]<- "0"
...
g <- ggbiplot(pca,choices=1:2, obs.scale = 1, var.scale = 1, 
              groups = cancertype, var.axes=FALSE)
